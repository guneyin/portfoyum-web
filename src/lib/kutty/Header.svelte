    ...
    <div class="flex items-center justify-between mx-auto max-w-7xl">
      <div class="flex items-center space-x-3">
        <div class="inline-flex md:hidden">
          <button class="flex-none px-2 btn btn-white btn-sm" on:click={open = true}>
          ...
          <div class="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 m-2 space-y-2 bg-white rounded shadow" x-cloak>
            <button class="self-start flex-none px-2 btn btn-link btn-icon" on:click={open = false}>
              <svg
            ...
            <a class="w-full btn btn-icon btn-link" href="#">
            ...
            <a class="w-full btn btn-icon btn-primary" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mr-2">
        ...
        <div class="hidden space-x-1 md:inline-flex">
          <a class="btn btn-sm btn-icon btn-link" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mr-2">
              <path
                d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"
              />
      ...
      <div class="flex items-center space-x-3">
        <div class="form-icon">
          ...
          <input class="mt-0 text-sm form-input" placeholder="Search..." />
        </div>
  
        <a href="#" class="p-3 text-gray-800 rounded hover:text-primary">
        ...
        <div x-data="dropdown()">
          <button class="p-0 rounded-full btn btn-white" x-spread="trigger">
            <div class="avatar avatar-sm">
              <img src="/placeholder.jpg" alt="Photo of Praveen Juge" />
            </div>
          </button>
          <div class="dropdown-list" id="profile-menu" x-position="left-start" x-spread="dropdown" x-cloak>
            <p class="dropdown-header">Praveen Juge</p>
